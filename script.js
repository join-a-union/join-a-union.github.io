...
function changedOccupation(){
	if(occupationSelect.value != ""){
        ...
        var ret = genUnionTable(union_data2, $("box2_unionTable"), true);
        $("box2_unionTable").style.display = "revert";
        $("box2_unionTable").classList.add("animate-opacity");
...
function form1_change(){
    ...
    if($("radio1nojob").checked){
        ...
        /*$("box2_unionTable").style.display = "revert";
        $("box2_unionTable").classList.add("animate-opacity");*/
        genUnionTable(union_data2, $("box2_unionTable"), false, true);
...
function btnShowApprenticeshipList_Click(){
    if($("box2_unionTable").style.display == "none"){
        $("box2_unionTable").style.display = "revert";
        $("box2_unionTable").classList.add("animate-opacity");
    }else{
        $("box2_unionTable").style.display = "none";
